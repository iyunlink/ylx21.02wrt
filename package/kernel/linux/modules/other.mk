...
define KernelPackage/bd99954
  SUBMENU:=$(OTHER_MENU)
  TITLE:=X-power bd99954 battery charger support
  KCONFIG:=CONFIG_CHARGER_BD99954=y \
...
define KernelPackage/bd99954/description
  This driver provides x-power bd99954 pmu support
endef

$(eval $(call KernelPackage,bd99954))


define KernelPackage/bq25700
  SUBMENU:=$(OTHER_MENU)
  TITLE:=X-power bq25700 battery charger support
  KCONFIG:=CONFIG_CHARGER_BQ25700=y \
			CONFIG_POWER_SUPPLY=y \
			CONFIG_REGMAP_I2C \
			CONFIG_HAS_IOMEM=y \
			CONFIG_I2C=y
  FILES:=$(LINUX_DIR)/drivers/power/supply/bq25700_charger.ko
  AUTOLOAD:=$(call AutoLoad,50,bq25700_charger)
endef

define KernelPackage/bq25700/description
  This driver provides x-power bq25700 pmu support
endef

$(eval $(call KernelPackage,bq25700))