            ...
            <div class="wrap-form">
             <form class="form-info" id="form0">
               ...
               <select class="mask" name="st_mask" onchange="mask_method()">
                    ...
                    <label class="">
                        <div class="name"><%= $wan_metric%>：</div>
                          <div>
                                <input name="wan_metric" type="text" value="<% uci get network.wan.metric %>" / >
                         </div>
                    </label>
                    <label class="">
                        <div class="name">专网LTE：</div>
                          <div>
                                <input name="g4_metric" type="text" value="<% uci get network.lte1.metric %>" / >
                         </div>
                    </label>
                    <label class="">
                        <div class="name">公网LTE：</div>
                          <div>
                                <input name="g4_metric2" type="text" value="<% uci get network.lte2.metric %>" / >
                         </div>
                    </label>
                    <!-- <label class="">
                        <div class="name"><%= $wwan_metric%>：</div>
                          <div>
                                <input name="wwan_metric" type="text" value="<% uci get network.wwanA.metric %>" / >
                         </div>
                    </label> -->
            </form>
				  <div class="btn-wrap">
