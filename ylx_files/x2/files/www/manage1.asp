    ...
    <div class="layout">
                            ...
                            <li>
                                <div class="menuname">
                                    <a target="main_frame" href="/dhcp1.asp"><%= $dhcp_setting%></a></div>
														...
														<li>
																<div class="menuname">
																		<a target="main_frame" href="/4g1.asp">4G1<%= $setting %></a></div>
														</li>
                                                        <li>
                                                            <div class="menuname">
                                                                    <a target="main_frame" href="/4g2.asp">4G2<%= $setting %></a></div>
                                                    </li>
														<li>
																<div class="menuname">
		...
		<div class="menuname"><cite class="m-icon08 sys-icon"></cite><%= $advance%></div>
			...
			<ul>
                ...
                <li>
                    <div class="menuname">
                        <a target="main_frame" href="/dmz1.asp">
                            <%= $dmz_setting%>
                        </a>
                    </div>
                </li>
                <li>
                    <div class="menuname">
                        <a target="main_frame" href="/portmap1.asp">
                            <%= $portmap %>
                        </a>
                    </div>
                </li>
                <li>
                    <div class="menuname">
                        <a target="main_frame" href="/route1.asp">
                            <%= $st_route %>
                        </a>
                    </div>
                </li>
                <li>
                    <div class="menuname">
                        <a target="main_frame" href="/remotehelp.asp">
                            <%= $remotehelp%>
                        </a>
                    </div>
                </li>
